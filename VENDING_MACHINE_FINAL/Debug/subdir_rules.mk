...
build-1284302737:
	@$(MAKE) -Onone -f subdir_rules.mk build-1284302737-inproc

build-1284302737-inproc: ../VM_RTOS.cfg
	@echo 'Building file: $<'
...
configPkg/linker.cmd: build-1284302737 ../VM_RTOS.cfg
configPkg/compiler.opt: build-1284302737
configPkg/: build-1284302737
