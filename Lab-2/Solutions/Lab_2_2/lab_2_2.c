 ...
 * Functions: setup(), ledPinConfig(), timerConfig(), interruptConfig(), switchPinConfig(), detectKeyPress(), Timer0IntHandler(), main()

 * Global Variables: ui32Period, pinName, sw2State, flag
