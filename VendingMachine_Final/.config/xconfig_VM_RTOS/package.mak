...
override PKGDIR = xconfig_VM_RTOS
...
package/%.xdc.inc package/%_xconfig_VM_RTOS.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_VM_RTOS" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: VM_RTOS.pem4f

-include package/cfg/VM_RTOS_pem4f.mak
-include package/cfg/VM_RTOS_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/VM_RTOS_pem4f.dep
endif
VM_RTOS.pem4f: package/cfg/VM_RTOS_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
VM_RTOS.pem4f package/cfg/VM_RTOS_pem4f.c: .libraries,em4f
endif

package/cfg/VM_RTOS_pem4f.c package/cfg/VM_RTOS_pem4f.h package/cfg/VM_RTOS_pem4f.xdl: override _PROG_NAME := VM_RTOS.xem4f
package/cfg/VM_RTOS_pem4f.c: package/cfg/VM_RTOS_pem4f.cfg
package/cfg/VM_RTOS_pem4f.xdc.inc: package/cfg/VM_RTOS_pem4f.xdl
package/cfg/VM_RTOS_pem4f.xdl package/cfg/VM_RTOS_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/VM_RTOS_pem4f.cfg
	-$(RM) package/cfg/VM_RTOS_pem4f.dep
	-$(RM) package/cfg/VM_RTOS_pem4f.c
	-$(RM) package/cfg/VM_RTOS_pem4f.xdc.inc

clean,em4f::
	-$(RM) VM_RTOS.pem4f
.executables,em4f .executables: VM_RTOS.xem4f

VM_RTOS.xem4f: |VM_RTOS.pem4f

-include package/cfg/VM_RTOS.xem4f.mak
VM_RTOS.xem4f: package/cfg/VM_RTOS_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@) -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/VM_RTOS_pem4f.oem4f   package/cfg/VM_RTOS_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
VM_RTOS.xem4f: export C_DIR=
VM_RTOS.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/:$(PATH)

VM_RTOS.test test,em4f test: VM_RTOS.xem4f.test

VM_RTOS.xem4f.test:: VM_RTOS.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 VM_RTOS.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.VM_RTOS.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,VM_RTOS.xem4f,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
VM_RTOS_pem4f.oem4f,copy : package/cfg/VM_RTOS_pem4f.oem4f
VM_RTOS_pem4f.sem4f,copy : package/cfg/VM_RTOS_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_VM_RTOS
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_VM_RTOS.tar.dep
endif
package/rel/xconfig_VM_RTOS/xconfig_VM_RTOS/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_VM_RTOS/xconfig_VM_RTOS/package/package.rel.xml: package/build.cfg
package/rel/xconfig_VM_RTOS/xconfig_VM_RTOS/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_VM_RTOS/xconfig_VM_RTOS/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_VM_RTOS.tar: package/rel/xconfig_VM_RTOS.xdc.inc package/rel/xconfig_VM_RTOS/xconfig_VM_RTOS/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_VM_RTOS.xdc.inc,package/rel/xconfig_VM_RTOS.tar.dep)


release release,xconfig_VM_RTOS: all xconfig_VM_RTOS.tar
clean:: .clean
	-$(RM) xconfig_VM_RTOS.tar
	-$(RM) package/rel/xconfig_VM_RTOS.xdc.inc
	-$(RM) package/rel/xconfig_VM_RTOS.tar.dep
