...
void ADC0IntHandler(void)
{
    ...
    ui8YAxisAvg = (ui32ADC0Value[0] + ui32ADC0Value[1] + ui32ADC0Value[2] + ui32ADC0Value[3] + 2)/64;
    flag = 1;
}
/*
...
void ADC1IntHandler(void)
{
    ...
    ui8XAxisAvg = (ui32ADC1Value[0] + ui32ADC1Value[1] + ui32ADC1Value[2] + ui32ADC1Value[3] + 2)/64;
    if(flag == 1)
    {
        flag = 0;
        sendUART();
