...
package/%.xdc.inc package/%_xconfig_game.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_game" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: game.pem4f

-include package/cfg/game_pem4f.mak
-include package/cfg/game_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/game_pem4f.dep
endif
game.pem4f: package/cfg/game_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
game.pem4f package/cfg/game_pem4f.c: .libraries,em4f
endif

package/cfg/game_pem4f.c package/cfg/game_pem4f.h package/cfg/game_pem4f.xdl: override _PROG_NAME := game.xem4f
package/cfg/game_pem4f.c: package/cfg/game_pem4f.cfg
package/cfg/game_pem4f.xdc.inc: package/cfg/game_pem4f.xdl
package/cfg/game_pem4f.xdl package/cfg/game_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/game_pem4f.cfg
	-$(RM) package/cfg/game_pem4f.dep
	-$(RM) package/cfg/game_pem4f.c
	-$(RM) package/cfg/game_pem4f.xdc.inc

clean,em4f::
	-$(RM) game.pem4f
.executables,em4f .executables: game.xem4f

game.xem4f: |game.pem4f

-include package/cfg/game.xem4f.mak
game.xem4f: package/cfg/game_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@) -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/game_pem4f.oem4f   package/cfg/game_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
game.xem4f: export C_DIR=
game.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/:$(PATH)

game.test test,em4f test: game.xem4f.test

game.xem4f.test:: game.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 game.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.game.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,game.xem4f,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
game_pem4f.oem4f,copy : package/cfg/game_pem4f.oem4f
game_pem4f.sem4f,copy : package/cfg/game_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_game
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_game.tar.dep
endif
package/rel/xconfig_game/xconfig_game/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_game/xconfig_game/package/package.rel.xml: package/build.cfg
package/rel/xconfig_game/xconfig_game/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_game/xconfig_game/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_game.tar: package/rel/xconfig_game.xdc.inc package/rel/xconfig_game/xconfig_game/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_game.xdc.inc,package/rel/xconfig_game.tar.dep)


release release,xconfig_game: all xconfig_game.tar
clean:: .clean
	-$(RM) xconfig_game.tar
	-$(RM) package/rel/xconfig_game.xdc.inc
	-$(RM) package/rel/xconfig_game.tar.dep
